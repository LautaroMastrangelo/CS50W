    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(choices=[('Electronics', 'Electronics'), ('Fashion', 'Fashion'), ('Home & Garden', 'Home & Garden'), ('Books', 'Books'), ('Sports & Outdoors', 'Sports & Outdoors'), ('Automotive', 'Automotive'), ('Toys & Games', 'Toys & Games'), ('Health & Beauty', 'Health & Beauty'), ('Collectibles', 'Collectibles'), ('Other', 'Other')], max_length=64)),
